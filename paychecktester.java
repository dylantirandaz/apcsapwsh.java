...
public class PayCheckTester 
{
	public static void main(String[] args) 
	{
		...
		{
			employee = new PayCheck(name, true);
		}
		else
		{
			employee = new PayCheck(name, false);
		}
		System.out.println();
	...
	{	
		if (worker.isManager())
		{
			System.out.println("Manager " + worker.getName() + ": " 
				+ worker.getHours() + " hours");
		...
		else
		{
			...
			System.out.println("Sales Clerk " + worker.getName() + ": " 
			+ worker.getHours() + " hours");
			System.out.printf("Total wages: " + "$" + "%.2f", worker.calcWages());
			System.out.println();
			System.out.println();
